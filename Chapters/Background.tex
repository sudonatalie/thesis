...
% TODO some kind of figure that shows a math-y proposition, its representation as a type in Agda, the corresponding program satisfying the type, thereby proving the math-y prop true
