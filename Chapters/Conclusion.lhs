...
Primarily, as shown by the results of the applications of our optimisations, our optimisations will reduce the runtime execution and heap allocation requirements of many Agda programs with a negligible impact on compile time edcomm{WK}{I don't recall where you showed measurements\ldots}, and do not show adverse effects in any of the tests we have performed.
