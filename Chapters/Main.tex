...
% TODO
\edcomm{WK}{Integrate pattern floating. Start writing about cross-call floating --- you can leave that in ``Next Steps'' as long as it does not work.}
